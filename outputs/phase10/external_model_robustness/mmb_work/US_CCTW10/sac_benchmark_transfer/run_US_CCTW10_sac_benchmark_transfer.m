addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/sac_benchmark_transfer');
        rng(1, 'twister');
        dynare('US_CCTW10_sac_benchmark_transfer.mod', 'noclearall', 'nolog', 'nostrict');
...
output_gap = sim(loc("y"), :) - sim(loc("yf"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/sac_benchmark_transfer/summary.csv');