addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/ppo_svar_revealed_direct_nonlinear');
        rng(1, 'twister');
        dynare('US_CCTW10_ppo_svar_revealed_direct_nonlinear.mod', 'noclearall', 'nolog', 'nostrict');
...
output_gap = sim(loc("y"), :) - sim(loc("yf"), :);
        ...
        row = table( ...
            string('ppo_svar_revealed_direct_nonlinear'), ...
            string('US_CCTW10'), ...
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/ppo_svar_revealed_direct_nonlinear/summary.csv');