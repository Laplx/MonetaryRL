addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/ppo_ann_revealed_direct_nonlinear');
        rng(1, 'twister');
        dynare('US_CCTW10_ppo_ann_revealed_direct_nonlinear.mod', 'noclearall', 'nolog', 'nostrict');
...
output_gap = sim(loc("y"), :) - sim(loc("yf"), :);
        ...
        row = table( ...
            string('ppo_ann_revealed_direct_nonlinear'), ...
            string('US_CCTW10'), ...
            "ann_revealed_direct", ...
            0.000007518659, ...
            -0.000005233387, ...
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/ppo_ann_revealed_direct_nonlinear/summary.csv');