addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/sac_ann_revealed_direct');
        rng(1, 'twister');
        dynare('US_CCTW10_sac_ann_revealed_direct.mod', 'noclearall', 'nolog', 'nostrict');
...
output_gap = sim(loc("y"), :) - sim(loc("yf"), :);
        ...
        row = table( ...
            string('sac_ann_revealed_direct'), ...
            string('US_CCTW10'), ...
            "ann_revealed_direct", ...
            -0.142674304846, ...
            0.092528694534, ...
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/sac_ann_revealed_direct/summary.csv');