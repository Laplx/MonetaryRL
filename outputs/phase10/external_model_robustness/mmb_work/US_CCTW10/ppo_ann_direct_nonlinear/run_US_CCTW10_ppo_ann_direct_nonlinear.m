addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/ppo_ann_direct_nonlinear');
        rng(1, 'twister');
        dynare('US_CCTW10_ppo_ann_direct_nonlinear.mod', 'noclearall', 'nolog', 'nostrict');
...
output_gap = sim(loc("y"), :) - sim(loc("yf"), :);
        ...
        row = table( ...
            string('ppo_ann_direct_nonlinear'), ...
            string('US_CCTW10'), ...
            "ann_direct", ...
            0.599940573471, ...
            0.599015036666, ...
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_CCTW10/ppo_ann_direct_nonlinear/summary.csv');