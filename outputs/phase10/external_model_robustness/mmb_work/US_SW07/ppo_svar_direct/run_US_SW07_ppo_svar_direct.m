addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_SW07/ppo_svar_direct');
        rng(1, 'twister');
        dynare('US_SW07_ppo_svar_direct.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("y"), :) - sim(loc("yf"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_SW07/ppo_svar_direct/summary.csv');