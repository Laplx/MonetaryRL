...
rho_R   = 0.930722986847;  // interest rate smoothing
rho_pi  = 0.067874143247; // Taylor rule coefficient for inflation
rho_y   = 0.050975043408;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
