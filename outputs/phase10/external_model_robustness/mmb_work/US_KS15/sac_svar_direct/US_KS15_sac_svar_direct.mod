...
rho_R   = 0.226215527375;  // interest rate smoothing
rho_pi  = 1.528632674699; // Taylor rule coefficient for inflation
rho_y   = 0.572243175257;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
