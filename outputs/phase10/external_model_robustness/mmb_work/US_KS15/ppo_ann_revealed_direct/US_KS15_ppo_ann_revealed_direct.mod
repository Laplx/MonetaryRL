...
rho_R   = 0.558572561736;  // interest rate smoothing
rho_pi  = 0.536859799780; // Taylor rule coefficient for inflation
rho_y   = -0.250778224863;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
