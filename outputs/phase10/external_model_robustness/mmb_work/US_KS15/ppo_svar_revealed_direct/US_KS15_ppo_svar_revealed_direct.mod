...
rho_R   = 0.613369948218;  // interest rate smoothing
rho_pi  = -0.336020154806; // Taylor rule coefficient for inflation
rho_y   = 0.177204269441;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
