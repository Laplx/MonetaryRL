...
rho_R   = 0.000003127369;  // interest rate smoothing
rho_pi  = 0.000007518659; // Taylor rule coefficient for inflation
rho_y   = -0.000005233387;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
