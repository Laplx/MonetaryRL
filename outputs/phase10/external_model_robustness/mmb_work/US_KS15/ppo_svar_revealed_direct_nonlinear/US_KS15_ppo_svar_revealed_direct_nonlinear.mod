...
rho_R   = -0.000798077192;  // interest rate smoothing
rho_pi  = 0.001085198436; // Taylor rule coefficient for inflation
rho_y   = -0.001727700271;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
