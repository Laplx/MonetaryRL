...
rho_R   = 0.417105133444;  // interest rate smoothing
rho_pi  = 0.968164929181; // Taylor rule coefficient for inflation
rho_y   = 1.178277175695;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
