...
rho_R   = 0.281656656641;  // interest rate smoothing
rho_pi  = 0.252398156782; // Taylor rule coefficient for inflation
rho_y   = 0.150362405774;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
