...
rho_R   = 0.396672274455;  // interest rate smoothing
rho_pi  = 1.173557590574; // Taylor rule coefficient for inflation
rho_y   = 1.021392382428;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
