...
rho_R   = 0.968364899969;  // interest rate smoothing
rho_pi  = -0.142674304846; // Taylor rule coefficient for inflation
rho_y   = 0.092528694534;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
