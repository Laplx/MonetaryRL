...
rho_R   = -0.105742465828;  // interest rate smoothing
rho_pi  = 1.246638007883; // Taylor rule coefficient for inflation
rho_y   = 0.507446602926;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
