...
rho_R   = 0.430588756274;  // interest rate smoothing
rho_pi  = -1.082625149309; // Taylor rule coefficient for inflation
rho_y   = 0.967378900239;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
