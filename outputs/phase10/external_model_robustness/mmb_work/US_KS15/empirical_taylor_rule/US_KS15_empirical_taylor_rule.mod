...
rho_R   = 0.869199767248;  // interest rate smoothing
rho_pi  = 0.193172811483; // Taylor rule coefficient for inflation
rho_y   = 0.265768574867;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
