addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_KS15/empirical_taylor_rule');
        rng(1, 'twister');
        dynare('US_KS15_empirical_taylor_rule.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("y"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_KS15/empirical_taylor_rule/summary.csv');