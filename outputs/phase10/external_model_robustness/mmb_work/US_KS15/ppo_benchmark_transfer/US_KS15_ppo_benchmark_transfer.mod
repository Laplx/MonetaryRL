...
rho_R   = 0.262907488912;  // interest rate smoothing
rho_pi  = 0.480967294574; // Taylor rule coefficient for inflation
rho_y   = 0.477126885802;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
