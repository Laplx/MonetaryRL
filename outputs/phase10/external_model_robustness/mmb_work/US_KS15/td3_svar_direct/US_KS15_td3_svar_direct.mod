...
rho_R   = -0.058737516184;  // interest rate smoothing
rho_pi  = 1.596124532350; // Taylor rule coefficient for inflation
rho_y   = 1.167307859480;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
