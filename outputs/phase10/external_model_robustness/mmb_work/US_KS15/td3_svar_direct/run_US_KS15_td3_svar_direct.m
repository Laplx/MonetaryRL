addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_KS15/td3_svar_direct');
        rng(1, 'twister');
        dynare('US_KS15_td3_svar_direct.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("y"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/US_KS15/td3_svar_direct/summary.csv');