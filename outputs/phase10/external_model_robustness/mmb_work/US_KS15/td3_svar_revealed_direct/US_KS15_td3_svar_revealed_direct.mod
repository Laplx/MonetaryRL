...
rho_R   = 0.947788173146;  // interest rate smoothing
rho_pi  = -0.002512149777; // Taylor rule coefficient for inflation
rho_y   = -0.148786795048;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
