...
rho_R   = 0.108078889288;  // interest rate smoothing
rho_pi  = -0.959321270308; // Taylor rule coefficient for inflation
rho_y   = 0.547218392198;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
...
stoch_simul(order=1, periods=3000, irf=0, nograph, noprint) R pit y;