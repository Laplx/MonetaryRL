...
rho_R   = 0.887135425573;  // interest rate smoothing
rho_pi  = -0.151140813549; // Taylor rule coefficient for inflation
rho_y   = 0.147202943961;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
