...
rho_R   = 0.528417882319;  // interest rate smoothing
rho_pi  = -1.202777588716; // Taylor rule coefficient for inflation
rho_y   = 1.125289038670;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
