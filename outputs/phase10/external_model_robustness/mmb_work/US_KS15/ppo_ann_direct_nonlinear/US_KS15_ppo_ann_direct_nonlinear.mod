...
rho_R   = 0.049123122828;  // interest rate smoothing
rho_pi  = 0.599940573471; // Taylor rule coefficient for inflation
rho_y   = 0.599015036666;    // Taylor rule coefficient for output
eta_ch  = 0.3;  // for R3
