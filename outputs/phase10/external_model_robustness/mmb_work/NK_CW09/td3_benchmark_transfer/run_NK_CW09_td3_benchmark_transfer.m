addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/NK_CW09/td3_benchmark_transfer');
        rng(1, 'twister');
        dynare('NK_CW09_td3_benchmark_transfer.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("Y_hat"), :) - sim(loc("Y_n_hat"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase10/external_model_robustness/mmb_work/NK_CW09/td3_benchmark_transfer/summary.csv');