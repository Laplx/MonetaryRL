...
T(18) = y(90)^params(51);
T(19) = y(90)^(params(50)-1);
T(20) = 1/params(42);
T(21) = (y(82)/params(47))^T(20);
T(22) = (y(83)/params(48))^T(20);
T(23) = (y(104)/params(49))^((-(1+params(42)))/params(42));
T(24) = (1+params(51))*params(93)^params(51);
T(25) = params(97)^(-1);
T(26) = (params(41)+T(25))^(-1);
end
