addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/NK_GHP16/sac_benchmark_transfer');
        rng(1, 'twister');
        dynare('NK_GHP16_sac_benchmark_transfer.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/NK_GHP16/sac_benchmark_transfer/summary.csv');