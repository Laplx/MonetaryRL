addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/NK_GHP16/sac_svar_revealed_direct');
        rng(1, 'twister');
        dynare('NK_GHP16_sac_svar_revealed_direct.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/NK_GHP16/sac_svar_revealed_direct/summary.csv');