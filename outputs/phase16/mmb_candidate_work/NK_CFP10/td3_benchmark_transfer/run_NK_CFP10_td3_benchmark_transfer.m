addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/NK_CFP10/td3_benchmark_transfer');
        rng(1, 'twister');
        dynare('NK_CFP10_td3_benchmark_transfer.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("yg"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/NK_CFP10/td3_benchmark_transfer/summary.csv');