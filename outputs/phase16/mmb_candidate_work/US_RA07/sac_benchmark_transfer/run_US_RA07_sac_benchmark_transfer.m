addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_RA07/sac_benchmark_transfer');
        rng(1, 'twister');
        dynare('US_RA07_sac_benchmark_transfer.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("y"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_RA07/sac_benchmark_transfer/summary.csv');