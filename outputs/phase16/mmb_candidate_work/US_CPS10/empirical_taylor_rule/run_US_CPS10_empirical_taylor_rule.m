addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_CPS10/empirical_taylor_rule');
        rng(1, 'twister');
        dynare('US_CPS10_empirical_taylor_rule.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outpgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_CPS10/empirical_taylor_rule/summary.csv');