addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/G7_TAY93/empirical_taylor_rule');
        rng(1, 'twister');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/G7_TAY93/empirical_taylor_rule/summary.csv');