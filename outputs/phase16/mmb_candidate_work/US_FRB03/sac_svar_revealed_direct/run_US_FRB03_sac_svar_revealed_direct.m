addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_FRB03/sac_svar_revealed_direct');
        rng(1, 'twister');
        dynare('US_FRB03_sac_svar_revealed_direct.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_FRB03/sac_svar_revealed_direct/summary.csv');