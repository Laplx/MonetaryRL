addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_FRB03/US_FRB03_baseline');
        rng(1, 'twister');
        dynare('US_FRB03_US_FRB03_baseline.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/US_FRB03/US_FRB03_baseline/summary.csv');