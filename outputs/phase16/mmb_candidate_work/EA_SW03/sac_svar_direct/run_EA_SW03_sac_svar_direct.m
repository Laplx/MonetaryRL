addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/EA_SW03/sac_svar_direct');
        rng(1, 'twister');
        dynare('EA_SW03_sac_svar_direct.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/EA_SW03/sac_svar_direct/summary.csv');