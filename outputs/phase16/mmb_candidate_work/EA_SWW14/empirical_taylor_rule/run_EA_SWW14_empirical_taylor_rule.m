addpath('C:/dynare/7.0/matlab');
        cd('C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/EA_SWW14/empirical_taylor_rule');
        rng(1, 'twister');
        dynare('EA_SWW14_empirical_taylor_rule.mod', 'noclearall', 'nolog');
...
output_gap = sim(loc("outputgap"), :);
        ...
        writetable(row, 'C:/Users/Laplace/Documents/Code/MonetaryRL/outputs/phase16/mmb_candidate_work/EA_SWW14/empirical_taylor_rule/summary.csv');